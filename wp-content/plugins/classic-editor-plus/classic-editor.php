...
require_once(YCE_CLASSES_PATH.'Css.php');
require_once(YCE_CLASSES_PATH.'Menu.php');
require_once(YCE_CLASSES_PATH.'Actions.php');
...
class YCE_Classic_Editor
{
	...
	public static function register_settings()
    {
		...
		add_settings_field('classic-editor-settings-2', $heading_2, array(__CLASS__, 'settings_2'), 'writing');
	}
